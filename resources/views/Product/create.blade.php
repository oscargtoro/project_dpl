...
@section('content')
	...
	<div class="col-sm">
		<div class="card" style="margin-top: 10px;">
			<div class="card-body">
				<form method="POST" action="/product" accept-charset="UTF-8" style="display:inline">
					@csrf			
					<div class="form-group">
						<label for="productName">Producto</label>
						<input type="text" class="form-control" name="name" id="productName" aria-describedby="comunalHelp">
