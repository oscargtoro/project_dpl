	...
	<div class="row" >
		<div class="col-sm">
			<div class="card" style="margin-top: 10px;">
				<div class="card-body">
					<form method="POST" action="/ciudad/{{$ciudad->codigo}}" accept-charset="UTF-8" style="display:inline">
						@csrf			
						@method('PUT')
						<div class="form-group">
							<label for="nombre">Ciudad</label>
							<input type="text" value = '{{$ciudad->nombre}}' class="form-control" name="nombre"/>
						</div>
