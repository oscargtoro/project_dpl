...
@section('content')
	...
	<div class="col-sm">
		<div class="card" style="margin-top: 10px;">
			<div class="card-body">
				<form method="POST" action="/permission" accept-charset="UTF-8" style="display:inline">
					@csrf			
					<div class="form-group">
						<label for="permissionName">Permiso</label>
						<input type="text" class="form-control" name="name" id="permissionName" aria-describedby="comunalHelp">
